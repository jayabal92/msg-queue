...
import (
	...
	"github.com/testorg/msg-queue/internal/log"
	"github.com/testorg/msg-queue/internal/metadata"
	"github.com/testorg/msg-queue/internal/replication"
...
func (s *Server) Start(ctx context.Context) error {
	...
	s.logger.Debug("broker registered successfully")
